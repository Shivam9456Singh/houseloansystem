...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Search your dream Home</a>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">House Rental System </div>
          <div class="intro-heading text-uppercase">Find your best Home!<br></div>
        </div>
      </div>
    </header>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Search by location</h2>
            <h3 class="section-subheading text-muted">Find your Place here !</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
